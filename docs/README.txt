...
Sledge 微妙に意識した、Web Application Framework です。以下のような点が特徴です。
...
http://localhost:5000/ でアプリケーションが立ち上がります。
...
Pickles::Dispatcher が Path::Router を使っています。~
